...
public final class ArtistDetailActivity extends MyBaseCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mArtistDetailOthBinding.toolbar.setNavigationOnClickListener(v -> finish());
    ...
    private void initData() {
        ...
        if (intent != null) {
            ...
            String artistName = intent.getStringExtra("key");
            String intentArtistId = String.valueOf(intent.getIntExtra("_id", -10));
            ...
            Observable.create((ObservableOnSubscribe<Integer>) emitter -> {
                ...
                Log.d(TAG, String.valueOf("initData: " + cursor == null));
