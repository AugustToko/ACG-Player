# Contributor's Guidelines for ACG-Player.

This is the contributor's guide for ACG-Player. In the event that this document was opened intentionally by you, it means you are keen on adding value to ACG-Player, and that is extremely stunning!.

ACG-Player is a completely opensource project. This means that our source code is available to anyone to use, modify, and redistribute within the confines of the [license](https://github.com/AugustToko/ACG-Player/blob/master/LICENSE). 
...
To request a new feature you should [open an issue](https://github.com/AugustToko/ACG-Player/issues/new?assignees=&labels=&template=feature_request.md&title=).
...
- Check the issue tracker if the bug hasn't been reported by other users. If it has been reported before it is likely to be in [opened issues](https://github.com/AugustToko/ACG-Player/issues?q=is%3Aopen+is%3Aissue). Also, check [closed issues](https://github.com/AugustToko/ACG-Player/issues?q=is%3Aissue+is%3Aclosed) too.
...
1. Fork the repository of the project which in this case is [ACG-Player](https://github.com/AugustToko/ACG-Player)
...
For further inquiries, you can contact the developer by opening an [issue](https://github.com/AugustToko/ACG-Player/issues/new) on the repository. You can also check out the developer's profile [here](https://github.com/AugustToko).

Thank you for your interest in contributing to ACG-Player.. I appreciate all the help with finding and fixing bugs, making performance improvements, and other tasks. Every contribution is helpful and I thank you for your effort.
